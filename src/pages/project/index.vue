  ...
  export default {
    data: {
      list: [{
        ...
        desc: ['1. 参与 DDS 功能需求的开发，官网价格计算器的版本迭代和上线；', '2. 基于 ng7 搭建了 Geminidb(多模 NoSQL 数据库)项目结构并完成了 70%业务代码的开发；', '3. 输出国际化词条转换 excel 工具(重复词检测、excel 解析和生成)，提高了团队的工作效率；', '4. 基于 Selenium 等工具编写测试代码协助持续集成与自动化测试，保证代码的可靠和安全。']
      }, {
        name: '家政加',
        time: '2018.1 - 2018.7',
        work: 'rn微应用开发',
        ...
        time: '2017.2 - 2017.6',
        work: '前后端开发',
        desc: ['1. 负责项目部分前台界面模块、后台管理模块的排版布局、交互效果及业务功能开发；', '2. 基于 UI 图将常用场景组件化，开发菜单栏、提示弹窗、图片上传、富文本编辑器等公用组件。']
      }]
    },
    onShareAppMessage () {
      return {
